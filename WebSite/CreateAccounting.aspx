<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateAccounting.aspx.cs" Inherits="ERP.CreateAccounting" %>
        ...
        <fieldset>
            <table cellspacing="2" cellpadding="2" border="0" style="color: #333333; width: 99%;
                ...
                <tr>                    
                    <td>Role</td>
                    <td colspan="3">                        
                        <asp:RadioButton ID="rdoAccounting" runat="server" GroupName="role" Checked="true"  />Accounting
                        <asp:RadioButton ID="rdoAccountManager" runat="server" GroupName="role" />AccountManage
                        <asp:RadioButton ID="rdoBranchManager" runat="server" GroupName="role" />BranchManage
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
