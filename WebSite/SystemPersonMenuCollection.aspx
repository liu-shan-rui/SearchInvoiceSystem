<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SystemPersonMenuCollection.aspx.cs" Inherits="ERP.SystemPersonMenuCollection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    
    <div class="box_title">
        <asp:Label ID="lblInfoTitle" runat="server" Text="用户菜单卡片"></asp:Label>
    </div>
    ...
    <div class="box_title">
        <asp:Label ID="lblListTitle" runat="server" Text="用户菜单卡片列表"></asp:Label>
    </div>
    <div class="accountInfo">
        <table cellspacing="2" cellpadding="2" border="0" style="color: #333333; width: 99%;
            border-collapse: collapse; font-weight: normal; word-break: break-all;">
            <tr>
                <td>  <asp:Button ID="btnCreate" runat="server" Text="新建" onclick="btnCreate_Click"/>
